...
\begin{frame}
	...
	\begin{itemize}
		...
		\mode<beamer>{	
			\begin{align*}
			Try~\theta = 30^o:~ & F = \frac{0.75 \times 25 }{\cos(30) + 0.75 \sin(30)} = \SI{15.108}{kN}.\\
			Try~\theta = 50^o:~ & F = \frac{0.75 \times 25 }{\cos(50) + 0.75 \sin(50)} = \SI{15.403}{kN}.\\
			Try~\theta = 40^o:~ & F = \frac{0.75 \times 25 }{\cos(40) + 0.75 \sin(40)} = \SI{15.022}{kN}.\\
			Try~\theta = 35^o:~ & F = \frac{0.75 \times 25 }{\cos(35) + 0.75 \sin(35)} = \SI{15.008}{kN}.\\
			Try~\theta = 37.5^o:~ & F = \frac{0.75 \times 25 }{\cos(37.5) + 0.75 \sin(37.5)} = \SI{15.001}{kN}.			
			\end{align*}
