...
\begin{frame}
	...
	\begin{figure}[ht]
		...
		\caption*{Enigma has 150,738,274,937,250 possible states. Credits: Rutherford journal}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\begin{figure}[ht]
		...
		\caption*{Margaret Hamilton next to a stack of the Apollo Guidance Computer source code (1969, credits: MIT Museum) and Katie Bouman who developed the algorithm for creating the first-ever image of black hole (2019, credits: PBS).}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\mode<beamer>{		
		\begin{align*}
			& F_y = F \sin \theta \quad \& \quad F_x = F \cos \theta \\
		...
		\begin{empheq}[box=\tcbhighmath]{equation*}
			F = \frac{\mu \cdot W}{(\cos \theta + \mu \sin \theta)}
		\end{empheq}
	}
	\mode<handout>{
		\vspace{5cm}
