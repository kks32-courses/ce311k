...
\title[CE394M: isoparametric - gauss integration]{CE 311K: Introduction to Computer Methods} 
...
%------------------------------------------------
\begin{frame}
	\frametitle{Famous people in computing}
	\begin{figure}[ht]
		\centering
		\includegraphics[width=\textwidth]{figs/turing-bombe.png}
		\caption*{Credit: Rutherford Journal}
	\end{figure}
\end{frame}

\note{
	Enigma has 150,738,274,937,250 possible states.
}
...
\begin{frame}
	...
	\begin{figure}[ht]
		...
		\caption*{Credits: MIT Museum  and PBS}
	\end{figure}
\end{frame}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.85\textwidth]{figs/ana-before-snow.png}
	\caption*{}
\end{figure}
\end{frame}
...
%------------------------------------------------
\begin{frame}
\frametitle{Snow simulations}
\mode<beamer>{
	\begin{figure}[ht]
		\centering
		\includegraphics[width=0.85\textwidth]{figs/ana-snow.png}
		\caption*{Snow simulation}
	\end{figure}
}
\mode<handout>{
	\vspace{5cm}
