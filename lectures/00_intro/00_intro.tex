...
\begin{itemize}
	\item Krishna is a human so he can walk, write Python code, speak English, etc.
	\item Chewbacca is a wookie so he can walk, “mwaaarhrhh”, etc.
\end{itemize}
}
...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item equal sign is an \textbf{assignment} of a value to a variable name.
		\begin{lstlisting}[language=Python]
	pi = 3.14159
	pi_approx = 22/7
		\end{lstlisting}
		...
		\item retrieve value associated with name or variable by invoking the name, by typing \verb|pi|
